...
<article class="album-card glass-card overflow-hidden rounded-[1.75rem] border border-white/10" data-track-card='@json($trackPayload)'>
  <div class="relative">
    ...
    <div class="album-overlay absolute inset-0 flex items-end justify-between p-5">
      ...
      <div class="flex items-center gap-3">
        ...
        @endauth
        <button type="button" data-track-play class="flex h-12 w-12 items-center justify-center rounded-full bg-white text-slate-950">
