...
<section data-featured-player class="featured-player-card glass-card overflow-hidden rounded-[2rem] border border-neon-cyan/25 bg-neon-cyan/5 p-6 sm:p-8">
  ...
  <div class="grid gap-8 lg:grid-cols-[auto_1fr_auto] lg:items-center">
    <div class="player-cover-frame music-pulse relative mx-auto w-full max-w-[280px] overflow-hidden rounded-[2rem] border border-neon-cyan/25">
    ...
    <div class="min-w-0">
      ...
      <a data-featured-artist href="{{ $featuredTrack['artist'] ? route('artists.show', $featuredTrack['artist']['slug']) : route('artists.index') }}" class="mt-3 inline-flex items-center gap-2 text-base text-neon-cyan/70 transition hover:text-neon-cyan">
        <span class="h-2 w-2 rounded-full bg-neon-cyan"></span>
        {{ $featuredTrack['artist']['name'] ?? 'Naad-e-Maan' }}
      </a>
      <div class="mt-5 flex flex-wrap gap-3 text-xs uppercase tracking-[0.3em] text-neon-cyan/60">
        <span class="rounded-full border border-neon-cyan/25 bg-neon-cyan/10 px-4 py-2">{{ $featuredTrack['genre'] }}</span>
        <span class="rounded-full border border-neon-blue/30 bg-neon-blue/20 px-4 py-2 text-neon-cyan">{{ $featuredTrack['album']['title'] ?? 'Single Release' }}</span>
      </div>
      ...
      <div class="mt-6">
        <div class="mb-3 flex items-center justify-between text-xs text-neon-cyan/60">
    ...
    <div class="mx-auto flex w-full max-w-[240px] flex-col gap-5">
      <div class="grid grid-cols-3 gap-3">
        <button type="button" data-featured-prev class="player-control glass-card flex h-14 items-center justify-center rounded-full border border-neon-cyan/25 bg-neon-cyan/5 text-neon-cyan/90" aria-label="Previous featured track">
        ...
        <button type="button" data-featured-toggle class="player-control player-control-primary flex h-14 items-center justify-center rounded-full bg-neon-cyan text-neon-pink" aria-label="Play featured queue">
        ...
        <button type="button" data-featured-next class="player-control glass-card flex h-14 items-center justify-center rounded-full border border-neon-cyan/25 bg-neon-cyan/5 text-neon-cyan/90" aria-label="Next featured track">
      ...
      <div class="glass-card rounded-[1.5rem] border border-neon-cyan/25 bg-neon-cyan/5 p-4">
        <div class="flex items-center justify-between text-sm text-neon-cyan/75">
          <span>Volume</span>
      ...
      <div class="rounded-[1.5rem] border border-neon-cyan/30 bg-neon-cyan/10 px-4 py-4 text-sm leading-7 text-neon-cyan/80">
